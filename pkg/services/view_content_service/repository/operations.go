...
func (r *repo) FindOne(filter, projection bson.M) (viewContentEntity.ViewContentDB, error) {
	var ViewContent viewContentEntity.ViewContentDB
...
func (r *repo) Find(filter, projection bson.M) ([]viewContentEntity.ViewContentDB, error) {
	var viewContents []viewContentEntity.ViewContentDB
