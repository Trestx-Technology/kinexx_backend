...
func NewGroupUserRepository(collectionName string) GroupUserRepository {
	return &repo{
...
func (r *repo) FindOne(filter, projection bson.M) (entity.GroupUserDB, error) {
...
func (r *repo) Find(filter, projection bson.M) ([]entity.GroupUserDB, error) {
	var group_users []entity.GroupUserDB
