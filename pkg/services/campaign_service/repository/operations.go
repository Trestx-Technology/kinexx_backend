...
func NewCampaignRepository(collectionName string) CampaignRepository {
	return &repo{
...
func (r *repo) FindOne(filter, projection bson.M) (campaignEntity.Campaign, error) {
...
func (r *repo) Find(filter, projection bson.M) ([]campaignEntity.Campaign, error) {
	var brands []campaignEntity.Campaign
