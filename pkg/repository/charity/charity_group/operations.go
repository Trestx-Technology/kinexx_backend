...
func NewCharityGroupRepository(collectionName string) CharityGroupRepository {
	return &repo{
...
func (r *repo) FindOne(filter, projection bson.M) (entity.CharityGroupDB, error) {
	var group_user entity.CharityGroupDB
...
func (r *repo) Find(filter, projection bson.M) ([]entity.CharityGroupDB, error) {
	var group_users []entity.CharityGroupDB
